          ...
          <div className="col-md-12 py-5">
            <div className="row">
              <div className="col-md-3 mb-md-0 mb-4">
                <img
                  className="logo"
                  src={require('../Images/whitelogowithdotcom.jpg')}
                  alt="logo"
                />
                <Links
                  link="https://www.vezeeta.com/en/Generic/AboutUs"
                  name="About Us"
                />
                <Links
                  link="https://www.vezeeta.com/en/Generic/OurTeam"
                  name="Our Team"
                />
                <Links link="https://careers.vezeeta.com/" name="Careers" />
                <Links
                  link="https://www.vezeeta.com/en/Generic/News"
                  name="Press"
                />
              </div>
                ...
                <div className="row">
                  <div className="col-md-3 mb-md-0 mb-4">
                    ...
                    <ul className="list-unstyled">
                      <Links
                        link="https://www.vezeeta.com/en/specialties"
                        name="Speciality"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/areas"
                        name="Area"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/insurances"
                        name="Insurance"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/hospitals"
                        name="Hospital"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/clinics"
                        name="Center"
                      />
                    </ul>
                  </div>
                  <div className="col-md-3 mb-md-0 mb-4">
                    ...
                    <ul className="list-unstyled">
                      <Links
                        link="https://doctors.vezeeta.com/"
                        name="Join Vezeeta Doctors"
                      />
                    </ul>
                  </div>
                  <div className="col-md-3 mb-md-0 mb-4">
                    ...
                    <ul className="list-unstyled">
                      <Links
                        link="https://www.vezeeta.com/en/Generic/ContactUs"
                        name="Contact Us"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/termsofuse"
                        name="Terms Of Use"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/Generic/PrivacyPolicy"
                        name="Privacy Policy"
                      />
                      <Links
                        link="https://www.vezeeta.com/en/Generic/DoctorsPrivacyPolicy"
                  ...
                  <div className="col-md-3">
                    <div className="col-12">
                      ...
                      <div className=" row col p-2">
                        <div className="col-3 ">
                          <a
                            href="https://www.facebook.com/martydevelopment/"
                            target="_blank"
                          >
                            <i
                              className="aaaa fab fa-facebook"
                              tabIndex="0"
                            ></i>
                          </a>
                        </div>
                        ...
                        <div className="col-3 ">
                          <a
                            href="https://www.instagram.com/marty.development/"
                            target="_blank"
                          >
                            <i
                              className="aaaa fab fa-instagram"
                              tabIndex="0"
                            ></i>
                          </a>
                        </div>
